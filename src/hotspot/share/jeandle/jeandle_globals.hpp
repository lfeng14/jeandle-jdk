...
//
#define JEANDLE_FLAGS(develop, develop_pd, product, product_pd, notproduct,               \
                      range, constraint)                                                  \
                                                                                          \
      ...
      product(bool, JeandleDumpIR, false,                                                 \
          ...
          product(ccstr, JeandleDumpDirectory, nullptr,                                   \
                  "Dump destination for all Jeandle items")                               \
                                                                                          \
              develop(bool, JeandleCrashOnError,                                          \
                  ...
                  product(bool, JeandleDumpRuntimeStubs, false,                           \
                          "Dump Jeandle runtime stubs")                                   \
                                                                                          \
                      product(                                                            \
                          bool, JeandleUseHotspotIntrinsics, false,                       \
                          ...
                          product(ccstr, JeandleLLVMOptions, nullptr,                     \
                              ...
                              product(bool, JeandleRecordVMCallbacks, false,              \
                                      "Record VM callback invocations for "               \
                                      "standalone LLVM testing")                          \
                                                                                          \
                                  product(bool, JeandleUseProfile, true,                  \
                                          "Use interpreter/C1 profile (MDO) "             \
                                          "for branch/switch weights, "                   \
                                      ...
                                      product(                                            \
                                          ...
                                          true,                                           \
                                          "Use receiver type profile to "                 \
                                          "devirtualize "                                 \
                                          "invokevirtual/invokeinterface "                \
                                          "calls in Jeandle")                             \
                                                                                          \
                                          product(intx,                                   \
                                                  JeandleNodeCountInliningCutoff,         \
                                                  18000,                                  \
                                                  "If root LLVM IR "                      \
                                              ...
                                              product(                                    \
                                                  bool,                                   \
                                                  JeandlePrintInlineTree,                 \
                                                  false,                                  \
                                                  "Print Jeandle inline tree "            \
                                                  "before installing "                    \
                                                  "compiled code")                        \
                                                                                          \
                                                  product(                                \
                                                      ...
                                                      "Run Partial Escape "               \
                                                      "Analysis (PEA) in the "            \
                                                      "Jeandle optimization "             \
                                                      "pipeline")                         \
                                                                                          \
                                                      product(                            \
                                                          bool,                           \
                                                          JeandleEliminateLocks,          \
                                                          true,                           \
                                                          "Enable lock "                  \
                                                          "elimination in "               \
                                                          "Jeandle PEA")                  \
